...
const COMMON_I18N = {
  tr: {
    ...
    "foot.home":"Ana sayfa →",
    "footer.tagline":"<span class=\"nw\">İlk <em>yuva</em>sındaki,</span> o ilk <em>an</em>. Sonsuza Dek.","footer.explore":"Keşfet","footer.more":"Daha fazla","footer.privacy":"Gizlilik / KVKK","footer.cookies":"Çerez Politikası","nav.doctor_login":"Doktor Girişi","nav.about":"Hakkımızda","footer.shipping":"Teslimat & İade",
  ...
  en: {
    ...
    "foot.home":"Home →",
    "footer.tagline":"That first <em>moment</em>, its first <em>nest</em>. Forever.","footer.explore":"Explore","footer.more":"More","footer.privacy":"Privacy","footer.cookies":"Cookie Policy","nav.doctor_login":"Doctor Login","nav.about":"About","footer.shipping":"Shipping & Returns",
