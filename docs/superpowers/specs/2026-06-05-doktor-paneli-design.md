...
3. Sipariş durumunu açılır menüden değiştirir: **Yeni → İnceleniyor → Üretimde → Tamamlandı**, ayrıca her aşamada **İptal** edilebilir. Doktor bu durumu kendi listesinde görür (salt-okunur).
...
**Durumlar:** Yeni (mavi) · İnceleniyor (mor) · Üretimde (sarı) · Tamamlandı (yeşil) · İptal (gri). Akış: Yeni → İnceleniyor → Üretimde → Tamamlandı; İptal her aşamadan erişilebilir terminal durum.
...
- **order** (sipariş/gönderim): id, doctor_id, anne_adi, gebelik_haftasi, durum (new/reviewing/in_production/completed/cancelled), oluşturma tarihi, (admin notu opsiyonel).
...
## 10. Çözülen / Ertelenen Sorular

- **Bildirim kanalı** (e-posta/WhatsApp): **backend aşamasına ertelendi**. Backend olmadan gerçek bildirim gönderilemez; mock aşamada konu dışı.
- **Sipariş durumları**: 5 duruma sabitlendi → Yeni · İnceleniyor · Üretimde · Tamamlandı · İptal.
- **Panel dili**: yalnızca **Türkçe**. i18n eklenmeyecek.
